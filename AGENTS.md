...
| `/update`, `update`, `docs`, `sync docs`, `update readme` | **`update`** | [.agents/skills/update/SKILL.md](file:///d:/3D%20Portfolio/.agents/skills/update/SKILL.md) | End-to-end documentation, README.md, directory tree, and test metrics synchronization |
